...
function PlanillaForm() {
  ...
  const calcularAguinaldo = (
    ...
    const aniosAntiguedad =
      fechaBase.getFullYear() - fechaIngresoDate.getFullYear();
    ...
    if (aniosAntiguedad < 1) {
      const diferenciaMilisegundos =
        fechaBase.getTime() - fechaIngresoDate.getTime();
  ...
  const handleAguinaldoChange = (checked: boolean) => {
    ...
    const aguinaldoAmount = checked
      ? calcularAguinaldo(employee.baseSalary, employee.startDate)
      : 0;
    setFormData((prev) => ({
      ...prev,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const employeeData = mockEmployees.find(
      (emp) => emp.id === formData.selectedEmployee
    );
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleOvertimeChange(Number(e.target.value))
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    min="0"
                    step="1"
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {formatCurrency(formData.firstQuinzena)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Salario Quincena 2</span>
                    <span className="font-semibold">
                      {formatCurrency(formData.secondQuinzena)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Horas Extras ({formData.overtimeHours} horas)</span>
                    <span className="font-semibold">
                      {formatCurrency(formData.overtimePay)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {formatCurrency(formData.vacation)}
                    </span>
                  </div>
                  {formData.includeAguinaldo && (
                    <div className="flex justify-between">
                      <span>Aguinaldo</span>
                      <span className="font-semibold">
                        {formatCurrency(formData.aguinaldo)}
                      </span>
                    </div>
                  )}
              ...
              <div className="border-t pt-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>ISSS (3%)</span>
                    <span className="font-semibold">
                      {formatCurrency(calculations.isss)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>AFP (7.25%)</span>
                    <span className="font-semibold">
                      {formatCurrency(calculations.afp)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Retención Renta</span>
                    <span className="font-semibold">
                      {formatCurrency(calculations.rent)}
                    </span>
                  </div>
                  <div className="flex justify-between font-semibold pt-2 border-t">
              ...
              <div className="border-t pt-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {formatCurrency(calculations.insaforp)}
                    </span>
                  </div>
