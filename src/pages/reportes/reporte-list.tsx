...
import NewEmpleadoForm from "./components/crear-reporte-form"; // Botón "Crear Reportes"
import { MainLayout } from "../../layouts/main-layout";
import { formatCurrency } from "../../utils/format";
import { mockSalaryRecords } from "../mock-salary-records"; // Datos
...
function EmpleadoList() {
  const [recordToDelete, setRecordToDelete] = useState(null); // Estado para eliminar
  const [recordToEdit, setRecordToEdit] = useState(null); // Estado para editar
