...
import { mockSalaryRecords } from "../mock-salary-records";
...
export default function DashboardPage() {
  ...
  const [selectedMetric, setSelectedMetric] = useState<"totalSalary" | "totalDeductions" | "totalNet">("totalSalary");
  ...
  return (
    <div className="h-screen p-8">
      <header className="mb-6 text-center">
        <h1 className="text-3xl font-bold">Panel de Control - Resumen Salarial</h1>
            ...
            <tbody>
              {mockSalaryRecords.map((record) => (
                <tr key={record.month}>
                  ...
                  <td className="border border-gray-300 p-2">{record.totalSalary.toLocaleString("es-ES")}</td>
                  <td className="border border-gray-300 p-2">{record.totalDeductions.toLocaleString("es-ES")}</td>
                  <td className="border border-gray-300 p-2">{record.totalNet.toLocaleString("es-ES")}</td>
                </tr>
              ))}
            </tbody>
          </table>
